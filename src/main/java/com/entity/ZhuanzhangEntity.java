...
public class ZhuanzhangEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhuanzhangEntity() {

	}

	public ZhuanzhangEntity(T t) {
		try {
    ...
    public String toString() {
        return "Zhuanzhang{" +
            ...
            ", zhuanzhangUuidNumber=" + zhuanzhangUuidNumber +
            ", shoukuanfangName=" + shoukuanfangName +
            ", shoukuanfangZhanghu=" + shoukuanfangZhanghu +
            ", zhuanzhangMoney=" + zhuanzhangMoney +
            ", zhuanzhangContent=" + zhuanzhangContent +
            ", insertTime=" + insertTime +
            ", zhuanzhangTypes=" + zhuanzhangTypes +
            ", zhuanzhangYesnoTypes=" + zhuanzhangYesnoTypes +
            ", zhuanzhangYesnoText=" + zhuanzhangYesnoText +
            ", zhuanzhangShenheTime=" + zhuanzhangShenheTime +
