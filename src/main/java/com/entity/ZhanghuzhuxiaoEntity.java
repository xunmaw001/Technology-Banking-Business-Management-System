...
public class ZhanghuzhuxiaoEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhanghuzhuxiaoEntity() {

	}

	public ZhanghuzhuxiaoEntity(T t) {
		try {
    ...
    public String toString() {
        return "Zhanghuzhuxiao{" +
            "id=" + id +
            ", yonghuId=" + yonghuId +
            ", zhanghuzhuxiaoUuidNumber=" + zhanghuzhuxiaoUuidNumber +
            ", insertTime=" + insertTime +
            ", zhanghuzhuxiaoContent=" + zhanghuzhuxiaoContent +
            ", zhanghuzhuxiaoYesnoTypes=" + zhanghuzhuxiaoYesnoTypes +
            ", zhanghuzhuxiaoYesnoText=" + zhanghuzhuxiaoYesnoText +
            ", zhanghuzhuxiaoShenheTime=" + zhanghuzhuxiaoShenheTime +
