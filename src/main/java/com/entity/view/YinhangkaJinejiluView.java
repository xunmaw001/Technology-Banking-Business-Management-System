...
public class YinhangkaJinejiluView extends YinhangkaJinejiluEntity implements Serializable {
	...
	public YinhangkaJinejiluView() {

	}

	public YinhangkaJinejiluView(YinhangkaJinejiluEntity yinhangkaJinejiluEntity) {
		try {
			BeanUtils.copyProperties(this, yinhangkaJinejiluEntity);
