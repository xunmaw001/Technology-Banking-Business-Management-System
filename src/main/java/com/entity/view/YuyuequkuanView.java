...
public class YuyuequkuanView extends YuyuequkuanEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String yuyuequkuanYesnoValue;
	...
	public YuyuequkuanView() {

	}

	public YuyuequkuanView(YuyuequkuanEntity yuyuequkuanEntity) {
		try {
			BeanUtils.copyProperties(this, yuyuequkuanEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getYuyuequkuanYesnoValue() {
				return yuyuequkuanYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setYuyuequkuanYesnoValue(String yuyuequkuanYesnoValue) {
				this.yuyuequkuanYesnoValue = yuyuequkuanYesnoValue;
			}
