...
public class YinhangkabubanView extends YinhangkabubanEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String yinhangkabubanYesnoValue;
	...
	public YinhangkabubanView() {

	}

	public YinhangkabubanView(YinhangkabubanEntity yinhangkabubanEntity) {
		try {
			BeanUtils.copyProperties(this, yinhangkabubanEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getYinhangkabubanYesnoValue() {
				return yinhangkabubanYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setYinhangkabubanYesnoValue(String yinhangkabubanYesnoValue) {
				this.yinhangkabubanYesnoValue = yinhangkabubanYesnoValue;
			}
