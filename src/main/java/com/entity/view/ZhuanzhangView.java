...
public class ZhuanzhangView extends ZhuanzhangEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 转账状态的值
		*/
		private String zhuanzhangValue;
		/**
		* 审核状态的值
		*/
		private String zhuanzhangYesnoValue;
	...
	public ZhuanzhangView() {

	}

	public ZhuanzhangView(ZhuanzhangEntity zhuanzhangEntity) {
		try {
			BeanUtils.copyProperties(this, zhuanzhangEntity);
			...
			* 获取： 转账状态的值
			*/
			public String getZhuanzhangValue() {
				return zhuanzhangValue;
			}
			/**
			* 设置： 转账状态的值
			*/
			public void setZhuanzhangValue(String zhuanzhangValue) {
				this.zhuanzhangValue = zhuanzhangValue;
			}
			/**
			* 获取： 审核状态的值
			*/
			public String getZhuanzhangYesnoValue() {
				return zhuanzhangYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setZhuanzhangYesnoValue(String zhuanzhangYesnoValue) {
				this.zhuanzhangYesnoValue = zhuanzhangYesnoValue;
			}
