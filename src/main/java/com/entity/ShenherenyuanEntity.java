...
public class ShenherenyuanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShenherenyuanEntity() {

	}

	public ShenherenyuanEntity(T t) {
		try {
    ...
    public String toString() {
        return "Shenherenyuan{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", shenherenyuanUuidNumber=" + shenherenyuanUuidNumber +
            ", shenherenyuanName=" + shenherenyuanName +
            ", shenherenyuanPhone=" + shenherenyuanPhone +
            ", shenherenyuanIdNumber=" + shenherenyuanIdNumber +
            ", shenherenyuanPhoto=" + shenherenyuanPhoto +
            ", sexTypes=" + sexTypes +
            ", shenherenyuanEmail=" + shenherenyuanEmail +
