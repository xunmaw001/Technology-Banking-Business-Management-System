        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否注销" prop="zhuxiaoTypes">
                        <el-select v-model="ruleForm.zhuxiaoTypes" :disabled="ro.zhuxiaoTypes" placeholder="请选择是否注销">
                            <el-option
                                v-for="(item,index) in zhuxiaoTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="是否注销" prop="zhuxiaoValue">
                        <el-input v-model="ruleForm.zhuxiaoValue"
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhuxiao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhuxiaoTypesOptions = data.data.list;
                    }
                });
