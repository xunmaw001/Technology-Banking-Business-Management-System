    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="业务员工号" prop="yewurenyuanUuidNumber">
                       <el-input v-model="ruleForm.yewurenyuanUuidNumber"
                                 placeholder="业务员工号" clearable  :readonly="ro.yewurenyuanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yewurenyuanPhoto" label="业务人员头像" prop="yewurenyuanPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.yewurenyuanPhoto?ruleForm.yewurenyuanPhoto:''"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="yewurenyuanEmail">
                       <el-input v-model="ruleForm.yewurenyuanEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.yewurenyuanEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="电子邮箱" prop="yewurenyuanEmail">
                           <el-input v-model="ruleForm.yewurenyuanEmail"
        ...
        data() {
            return {
                ...
                ruleForm: {
                    username: '',
                    password: '',
                    yewurenyuanUuidNumber: new Date().getTime(),
                    yewurenyuanName: '',
                    yewurenyuanPhone: '',
                    yewurenyuanIdNumber: '',
                    yewurenyuanPhoto: '',
                ...
                rules: {
                   ...
                   yewurenyuanUuidNumber: [
                              { required: true, message: '业务员工号不能为空', trigger: 'blur' },
                          ],
                   yewurenyuanName: [
